...
export const PRESETS: Record<PresetKey, PresetDef> = {
  overview: {
    ...
    slots: [
      ...
      { dimension: "county", measure: "count", chartType: "bar", order: 3 },
    ],
  },
  time: {
    label: "Time Patterns",
  ...
  rates: {
    ...
    slots: [
      ...
      { dimension: "cause", measure: "killed", chartType: "bar", order: 1 },
      { dimension: "year", measure: "killed", chartType: "line", order: 2 },
  ...
  seasonal: {
    ...
    slots: [
      ...
      { dimension: "county", measure: "injured", chartType: "bar", order: 2 },
    ],
  },
};
